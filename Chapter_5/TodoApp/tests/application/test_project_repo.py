# 프로젝트 리포지토리 인메모리 구현체의 삭제 기능 테스트
# - 존재하는 프로젝트 삭제, 존재하지 않는 프로젝트 삭제, 삭제 후 재생성 시나리오 검증
