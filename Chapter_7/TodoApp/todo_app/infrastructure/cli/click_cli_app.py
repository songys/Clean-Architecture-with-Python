...
프레임워크 및 드라이버 계층에 위치하며, Click 라이브러리를 활용하여
사용자 입력을 받고 Application 컨테이너의 컨트롤러에 전달.
"""
...
class ClickCli:
    """Click 라이브러리 기반 CLI 프레임워크 어댑터 — 사용자 인터페이스 담당."""
    ...
    def _create_task(self, project_id: str) -> Optional[TaskViewModel]:
        ...
        click.echo("[2] 보통")
        click.echo("[3] 높음")
        priority_choice = click.prompt("우선순위를 선택하세요", type=str, default="2")
    ...
    def _update_task_priority(self, task_id: str) -> None:
        ...
        choice = click.prompt("우선순위를 선택하세요", type=str)
