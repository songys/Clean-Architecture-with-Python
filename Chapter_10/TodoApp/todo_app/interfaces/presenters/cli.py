# CLI 전용 프레젠터 모듈
# - TaskPresenter/ProjectPresenter 추상 클래스의 CLI 구현
# - 터미널 출력에 적합한 형식으로 데이터 포맷팅 (괄호 표시, 텍스트 기반)
...
class CliTaskPresenter(TaskPresenter):
    """CLI 전용 작업 프레젠터.
    - 상태를 [TODO], [DONE] 형식으로 표시
    - 우선순위를 Minor/Normal/High로 변환
    """
    ...
    def present_task(self, task_response: TaskResponse) -> TaskViewModel:
        ...
        return TaskViewModel(
            ...
            project_display=(
                f"프로젝트: {task_response.project_id}" if task_response.project_id else ""
            ),
