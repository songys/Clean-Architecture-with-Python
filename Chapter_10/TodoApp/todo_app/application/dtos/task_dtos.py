...
이러한 DTO는 외부 계층과 애플리케이션 핵심 간의 데이터 변환을 처리한다.
"""
...
class TaskResponse:
    ...
    id: str  # 경계 횡단을 위한 UUID 변환 필요
    title: str
    description: str
    status: TaskStatus
    priority: Priority
    project_id: str  # 경계 횡단을 위한 UUID 변환 필요
...
class UpdateTaskRequest:
    ...
    def to_execution_params(self) -> dict:
        ...
        # due_date가 제공된 경우 항상 매개변수에 deadline 포함
